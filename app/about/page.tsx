      ...
      <Container className="py-10">
        ...
        <div className="mt-6 max-w-3xl space-y-5 text-muted-foreground">
          ...
          <p>
            ...
            licensed financial advisers, and Bonus Foundry is not an official website of any listed provider.
          </p>
          <p>
          ...
          <p>
            Bonus Foundry is referral-supported. We do not accept user-submitted codes, paid listings, or referral
            marketplace submissions, and pages should only display Bonus Foundry-owned referral codes or referral links.
          </p>
        </div>
        <div className="mt-10 max-w-3xl">
          <KeyFacts
            ...
            facts={[
              ...
              { label: "Independence", value: "Bonus Foundry is independent and is not an official provider website." },
